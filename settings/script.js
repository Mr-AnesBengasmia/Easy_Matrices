const intM11 = document.getElementById("x1").querySelector('input').value;
const intM12 = document.getElementById("x2").querySelector('input').value;
const intM13 = document.getElementById("x3").querySelector('input').value;
const intM21 = document.getElementById("y1").querySelector('input').value;
const intM22 = document.getElementById("y2").querySelector('input').value;
const intM23 = document.getElementById("y3").querySelector('input').value;
const intM31 = document.getElementById("z1").querySelector('input').value;
const intM32 = document.getElementById("z2").querySelector('input').value;
const intM33 = document.getElementById("z3").querySelector('input').value;
const intN1 = document.getElementById("n1").querySelector('input').value;
const intN2 = document.getElementById("n2").querySelector('input').value;
const intN3 = document.getElementById("n3").querySelector('input').value;
